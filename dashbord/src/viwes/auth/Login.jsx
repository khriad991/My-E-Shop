        ...
        <div className='min-w-screen min-h-screen bg-[#161d31] flex justify-center items-center'>
            <div className="w-[400px] text-[#d0d2d6] p-4   ">
                <div className='bg-[#283046] p-4 rounded-md'>
                    ...
                    <p className='text-sm mb-3'>Please Sing In to in your account & start your business</p>
                    <form action="" onSubmit={submit}>
                        ...
                        <button className='bg-blue-500 w-full hover:hover:shadow-blue-500/40 transition-all duration-400 hover:shadow-lg text-white rounded-md px-7 py-2 mb-3'>Sing In</button>
                        <div className="flex items-center mb-4 gap-3">
                            <p>Not have An Account ? <Link className='text-blue-400' to='/register'>SingUp Here</Link> </p>
                        </div>
